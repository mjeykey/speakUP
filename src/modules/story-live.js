...
import { ensureStoryEffect, prepareStoryEffects, stopStoryEffects, transitionStoryEffects } from '../audio/story-effects.js?v=214';
...
export function renderStory(root,store){
  ...
  const phaseSound=(sourcePage=pageIndex,sourcePhase=phaseIndex)=>sourcePage===10?(sourcePhase<=2?'metal-scrape':'none'):(story.pages[sourcePage]?.sound||'none');
