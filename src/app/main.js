...
import { renderWords } from '../modules/words.js?v=56';
import { renderMemory } from '../modules/memory-full-speech.js?v=1';
import { renderFillGap } from '../modules/fill-gap.js?v=69';
...
import { renderEffectsSettings } from '../modules/effects-settings.js?v=57';
