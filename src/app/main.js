...
import { renderMenu } from '../modules/menu.js?v=197';
...
import { renderStory } from '../modules/story-loader.js?v=152';
...
import { stopStoryEffects } from '../audio/story-effects.js?v=4';
