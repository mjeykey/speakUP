...
import { getHtmlLanguage } from './ui-language.js?v=3';
import { renderWelcome } from '../modules/welcome.js?v=53';
import { renderMenu } from '../modules/menu.js?v=267';
import { renderWords } from '../modules/words-matrix.js?v=3';
import { renderMemory } from '../modules/memory-matrix.js?v=4';
import { renderFillGap } from '../modules/fill-gap-matrix.js?v=3';
...
import { renderEmotions } from '../modules/emotions-expanded.js?v=3';
...
import { renderL3Learning } from '../modules/l3-learning.js?v=3';
