...
const MENU = {
  en:{
    ...
    modes:{emotions:['Emotions','Words, sentences and playful expressions for feelings.'],anxiety:['Anxiety','Learn with short stories about anxious thoughts, perspective and humour.'],'fill-gap':['Sentences','Choose your level and complete the sentence.'],memory:['Memory','Match words and meanings.'],words:['Words','One word at a time.'],'speak-practice':['Speaking','Say useful sentences out loud.'],'repeat-practice':['Repeat after me','Listen, repeat and practise with the microphone.'],'communication-strength':['Communication','Learn clearer ways to say things.'],story:['Stories','Learn language through short stories.']},
  ...
  de:{
    ...
    modes:{emotions:['Emotionen','Wörter, Sätze und Ausdrücke für Gefühle.'],anxiety:['Anxiety','Lerne mit kurzen Geschichten über ängstliche Gedanken, Perspektive und Humor.'],'fill-gap':['Sätze','Wähle dein Level und ergänze den Satz.'],memory:['Memory','Finde passende Wörter und Bedeutungen.'],words:['Wörter','Ein Wort nach dem anderen.'],'speak-practice':['Sprechen','Sprich nützliche Sätze laut aus.'],'repeat-practice':['Nachsprechen','Anhören, nachsprechen und mit dem Mikrofon üben.'],'communication-strength':['Kommunikation','Lerne klarere Formulierungen.'],story:['Geschichten','Lerne Sprache in kurzen Geschichten.']},
  ...
  es:{
    ...
    modes:{emotions:['Emociones','Palabras, frases y expresiones para los sentimientos.'],anxiety:['Ansiedad','Aprende con pequeñas historias sobre pensamientos ansiosos, perspectiva y humor.'],'fill-gap':['Frases','Elige tu nivel y completa la frase.'],memory:['Memoria','Relaciona palabras y significados.'],words:['Palabras','Una palabra cada vez.'],'speak-practice':['Hablar','Di frases útiles en voz alta.'],'repeat-practice':['Repetir','Escucha, repite y practica con el micrófono.'],'communication-strength':['Comunicación','Aprende formas más claras de decir las cosas.'],story:['Historias','Aprende el idioma con pequeñas historias.']},
  ...
  fr:{
    ...
    modes:{emotions:['Émotions','Mots, phrases et expressions pour les émotions.'],anxiety:['Anxiété','Apprends avec de petites histoires sur les pensées anxieuses, le recul et l’humour.'],'fill-gap':['Phrases','Choisis ton niveau et complète la phrase.'],memory:['Mémoire','Associe les mots et les significations.'],words:['Mots','Un mot à la fois.'],'speak-practice':['Parler','Prononce des phrases utiles à voix haute.'],'repeat-practice':['Répéter','Écoute, répète et pratique avec le microphone.'],'communication-strength':['Communication','Apprends des formulations plus claires.'],story:['Histoires','Apprends la langue avec de petites histoires.']},
