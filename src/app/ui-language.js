...
const STORY_UI = {
  en:{menu:'Menu',story:'Story',page:'Page',previous:'Previous',beginning:'Beginning',next:'Next',complete:'Complete the story',found:'All learning words found.',review:'Review',soundOn:'Sound on',soundOff:'Sound off'},
  de:{menu:'Menü',story:'Geschichte',page:'Seite',previous:'Zurück',beginning:'Anfang',next:'Weiter',complete:'Vervollständige die Geschichte',found:'Alle Lernwörter gefunden.',review:'Wiederholung',soundOn:'Ton an',soundOff:'Ton aus'},
  pt:{menu:'Menu',story:'História',page:'Página',previous:'Anterior',beginning:'Início',next:'Seguinte',complete:'Completa a história',found:'Encontraste todas as palavras.',review:'Revisão',soundOn:'Som ligado',soundOff:'Som desligado'},
  es:{menu:'Menú',story:'Historia',page:'Página',previous:'Anterior',beginning:'Inicio',next:'Siguiente',complete:'Completa la historia',found:'Has encontrado todas las palabras.',review:'Repaso',soundOn:'Sonido activado',soundOff:'Sonido desactivado'},
  hr:{menu:'Izbornik',story:'Priča',page:'Stranica',previous:'Prethodno',beginning:'Početak',next:'Dalje',complete:'Dovrši priču',found:'Pronađene su sve riječi.',review:'Ponavljanje',soundOn:'Zvuk uključen',soundOff:'Zvuk isključen'},
  fr:{menu:'Menu',story:'Histoire',page:'Page',previous:'Précédent',beginning:'Début',next:'Suivant',complete:'Complète l’histoire',found:'Tous les mots ont été trouvés.',review:'Révision',soundOn:'Son activé',soundOff:'Son désactivé'}
};
